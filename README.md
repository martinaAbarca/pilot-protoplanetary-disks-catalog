...
Abarca Ibarra, M. I. (2026). *Pilot Catalog of Protoplanetary Disks* (Version 1.0.0). Zenodo. https://doi.org/10.5281/zenodo.xxxxxxx

## Español

Si usas este catálogo, por favor cítalo como:

Abarca Ibarra, M. I. (2026). *Catálogo piloto de discos protoplanetarios* (Versión 1.0.0). Zenodo. https://doi.org/10.5281/zenodo.xxxxxxx

> Replace `https://doi.org/10.5281/zenodo.xxxxxxx` with the DOI generated by Zenodo after publishing the release.
